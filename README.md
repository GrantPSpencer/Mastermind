...
* GameRows – This is a component within the GameGUI frame that is comprised of each of the 10 rows that contain the 0-7 dropdown boxes, the colored response squares, and the submit guess button.
...
3. After looping through the digits that have not been correctly placed in any guess, the user will then be given the locations of the digits they have already correctly placed, in the order they were placed. 
